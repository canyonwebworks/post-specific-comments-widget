 ...
 *
 * 	   https://www.paypal.me/canyonwebworks
 *
 *     Thank you.
 *
...
final class Post_Specific_Comments_Widget extends WP_Widget {
	...
	*/
	public function widget( $args, $instance ) {
		...
		if ( $post_id ) {
			$comments = get_comments( apply_filters( 'widget_comments_args', [ 'number' => $number, 'post_id' => $post_id, 'status' => 'approve', 'post_status' => 'publish'], $instance ) );
		} else {
...
add_action( 'plugins_loaded', [ 'Post_Specific_Comments_Widget', 'pscw_load_plugin_textdomain' ] );
